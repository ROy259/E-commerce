...
import { electronincs } from '../Dummydata'
import { Link } from 'react-router-dom'

const Electronincs = ({handle}) => {
  return (
    <div className='men-container justify-center pt-10 flex-col sm:flex-row sm:flex-wrap bg-slate-200 flex sm:justify-around mt-1 p-1'>
      {electronincs.map((item) => (
