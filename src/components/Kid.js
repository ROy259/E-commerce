...
import { kids } from '../Dummydata'
import { Link } from 'react-router-dom'

const Kid = ({handle}) => {
  return (
    <div className='men-container justify-center pt-10 bg-slate-200  flex-col sm:flex-row sm:flex-wrap flex sm:justify-around mt-1 p-1'>
      {kids.map((item) => (
